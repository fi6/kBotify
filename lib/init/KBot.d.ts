...
export declare class KBotify extends KaiheilaBot {
    commandMap: Map<string, MenuCommand<any> | AppCommand<any>>;
    help: string;
    botId: string;
    constructor(config: BotConfig);
    private processMsg;
    addCommand: (command: AppCommand<any> | MenuCommand<any>) => void;
    execute: (command: string, args: string[], msg: TextMessage) => Promise<void | import("../commands/shared/types").ResultTypes | import("axios").AxiosResponse<any>>;
}
