...
export declare type CommandInput = [string, string[], TextMessage];
...
export declare type ReplyMap = Map<string | number, [
    string | (() => Promise<string>) | (() => string),
    ResultTypes,
    SendOptions?
]>;
export declare type replyMapUnit = replyKv;
